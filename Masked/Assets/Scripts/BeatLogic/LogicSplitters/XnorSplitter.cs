...
public class XnorSplitter : LogicSplitter
{
    ...
    public int[] GetNotesForBeat(int truthValue)
    {
        if (truthValue == 1)
        {
            // For XNOR operation, if the truth value is 1, spawn notes in an even number of lanes
        ...
        {
            // If the truth value is 0, spawn notes in an odd number of lanes
            System.Random rand = new System.Random();
